# sdkwork-settings Source Configuration
...
| Item | Value |
| --- | --- |
| `appId` | `sdkwork-settings` |
| `runtimeCode` | `settings` |
| Config root | `/etc/sdkwork/settings/` |
| Runtime TOML | `/etc/sdkwork/settings/config.toml` |
| Secrets | `/etc/sdkwork/settings/secrets/` |
| Override | `SDKWORK_SETTINGS_CONFIG_FILE` |
