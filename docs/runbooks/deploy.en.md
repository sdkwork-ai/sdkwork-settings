# Runbook — sdkwork-settings deploy / upgrade / rollback (EN)
...
targets. Image reference: `registry.sdkwork.com/apps/sdkwork-settings-standalone:0.1.0`
...
install syncs the bundle to `/opt/deploy/sdkwork-settings/bundle`, loads the image, starts
