...
| --- | --- | ---: | --- | --- |
| development | `server.development.toml` | 14 | `settings-dev.sdkwork.com` | 80 |
| test | `server.test.toml` | 14 | `settings-test.sdkwork.com` | 80 |
| staging | `server.staging.toml` | 14 | `settings-staging.sdkwork.com` | 80 |
| production | `server.production.toml` | 14 | `settings.sdkwork.com` | 443 ssl + 80 |
