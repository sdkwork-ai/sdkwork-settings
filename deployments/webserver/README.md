...
Module `sdkwork-settings` · runtime code `settings` · enabled
...
| --- | --- | ---: | --- | --- |
| development | `server.development.toml` | 16 | `settings-dev.sdkwork.com` | 80 |
| test | `server.test.toml` | 16 | `settings-test.sdkwork.com` | 80 |
| staging | `server.staging.toml` | 16 | `settings-staging.sdkwork.com` | 80 |
| demo | `server.demo.toml` | 16 | `settings-demo.sdkwork.com` | 80 |
| production | `server.production.toml` | 16 | `settings.sdkwork.com` | 443 ssl + 80 |
